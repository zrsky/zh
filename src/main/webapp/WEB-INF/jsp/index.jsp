            ...
            success: function (data) {
                ...
                if(data.length) {
                    ...
                    data.forEach(function(comment,index) {
                        ...
                        $("#comment" + id +" .commentWrappers").append('<div class="commentWrapper"><div class="media-left media-middle"><a href="./myIndex.html" style="font-size:16px; font-weight:normal;"><img class="media-object" src="images/avatar.jpg" width="25px" alt="..."><span class="username" style="font-size:16px;font-weight:normal;">' + comment.fromUserName + '</span></a></div><div class="media-body topic readBox"><span class="word">' + comment.content + '</span><p style="color:#9D9B9B;margin-top:20px;margin-bottom: 0px;">发布于 <span class="createTime">' + updateTime + '</span></p></div></div>')
